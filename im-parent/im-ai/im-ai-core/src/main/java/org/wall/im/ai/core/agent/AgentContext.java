...
public class AgentContext {
    ...
    public MemoryStore getShortTermMemory() { return shortTermMemory; }
    public void setShortTermMemory(MemoryStore shortTermMemory) { this.shortTermMemory = shortTermMemory; }

    public MemoryStore getLongTermMemory() { return longTermMemory; }
    public void setLongTermMemory(MemoryStore longTermMemory) { this.longTermMemory = longTermMemory; }
