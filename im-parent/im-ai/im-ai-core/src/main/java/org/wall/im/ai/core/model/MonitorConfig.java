...
public class MonitorConfig {
	...
	public LangfuseConfig getLangfuse() {
		return langfuse;
	}

	public void setLangfuse(LangfuseConfig langfuse) {
	...
	public static class LangfuseConfig {
		...
		public boolean isConfigured() {
			return publicKey != null && !publicKey.isEmpty() && secretKey != null && !secretKey.isEmpty();
		}
