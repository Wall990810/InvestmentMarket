...
/**
 * Spring AI工具适配器
 * <p>将自定义 {@link Tool} 接口桥接为Spring AI的 {@link ToolCallback}，
 * 使得自定义工具可以被Spring AI Alibaba的ReactAgent调用。</p>
 *
 * <p>使用方式：
 * <pre>{@code
...
public class SpringAiToolAdapter {
    ...
    public static ToolCallback toToolCallback(Tool tool) {
        return FunctionToolCallback
                .builder(tool.getName(), (String jsonInput) -> {
                    try {
                        Map<String, Object> parameters = OBJECT_MAPPER.readValue(
